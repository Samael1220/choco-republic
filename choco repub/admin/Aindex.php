...
<section class="admin-dashboard">
  ...
  <div class="stats-grid">
    <div class="stat-card"><i class="fas fa-box"></i><strong>Products</strong><div><?= $stats['products'] ?></div></div>
    <div class="stat-card"><i class="fas fa-shopping-cart"></i><strong>Orders</strong><div><?= $stats['orders'] ?></div></div>
    <div class="stat-card pending"><i class="fas fa-clock"></i><strong>Pending Orders</strong><div><?= $stats['pending'] ?></div></div>
    <div class="stat-card"><i class="fas fa-users"></i><strong>Users</strong><div><?= $stats['users'] ?></div></div>
  </div>
